...
const translate$3 = (key, defaultMessage) => {
...
const translate$1 = (key, defaultMessage) => {
    return get(translations$1, key) ?? defaultMessage;
};
registerExamples([
    {
        name: 'categorization',
...
const schema$r = personCoreSchema;
const uischema$r = undefined;
const data$t = data$H;
registerExamples([
    {
        name: 'generate-ui',
...
const data$9 = { oneOfMultiEnum: ['foo'], multiEnum: ['bar'] };
registerExamples([
    {
        name: 'multi-enum',
...
const data$4 = { oneOfMultiEnum: ['foo'], multiEnum: ['bar'] };
registerExamples([
    {
...
const data$1 = 'This is a test string';
registerExamples([
    {
        name: 'string',
        label: 'String',
...
export { additionalErrors$1 as additionalErrors, additionalProperties, allOf, anyOf, anyOfOneOfAllOfResolve, arrays as array, arraysI18n as arrayI18n, arraysWithCustomElementLabel as arrayWithCustomChildLabel, arraysWithDefaults as arrayWithDefaults, arraysWithDetail as arrayWithDetail, arraysWithDetailAndRule as arrayWithDetailAndRule, arraysWithSorting as arrayWithSorting, arraysWithTranslatedCustomElementLabel as arrayWithTranslatedCustomChildLabel, categorization, conditionalSchemaCompositions as conditionalSchemaComposition, config$1 as config, controlOptions, dates, _default as defaultExample, _enum as enumExample, enumInArray, generateDynamic, generate as generateSchema, generateUI as generateUISchema, getExamples, huge, i18n, if_then_else as ifThenElse, _1884 as issue_1884, _1948 as issue_1948, layout, listWithDetail, listWithDetailPrimitives, listWithDetailRegistered, login, enumMulti as multiEnum, enumMultiWithLabelAndDesc as multiEnumWithLabelAndDesc, nestedArrays as nestedArray, nestedCategorization, numbers, object, onChange$1 as onChange, oneOf, oneOfArray, oneOfRecursive, person, radioGroup as radioGroupExample, readonly, registerExamples, rule, ruleInheritance, scope, categorizationStepper as stepper, categorizationStepperNavButtons as steppershownav, string, stringArray, text };
